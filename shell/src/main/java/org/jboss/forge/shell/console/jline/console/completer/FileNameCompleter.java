 ...
 * <p/>
 * This completer tries to behave as similar as possible to <i>bash</i>'s file name completion (using GNU readline) with
         ...
         implements Completer
{
   ...
   {
      return org.jboss.forge.shell.console.jline.internal.Configuration.getUserHome();
   }
