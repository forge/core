    ...
    extends TerminalSupport
{
    ...
    public WindowsTerminal() throws Exception {
        ...
        this.replayStream =
            new org.jboss.forge.shell.console.jline.internal.ReplayPrefixOneCharInputStream(org.jboss.forge.shell.console.jline.internal.Configuration.getString(JLINE_WINDOWS_TERMINAL_INPUT_ENCODING, org.jboss.forge.shell.console.jline.internal.Configuration.getFileEncoding()));
