...
public class ConsoleReader
{
    ...
    public ConsoleReader(final InputStream in, final Writer out, final InputStream bindings, final org.jboss.forge.shell.console.jline.Terminal term) throws
        IOException
    {
        this.in = in;
        this.out = out;
        this.terminal = term != null ? term : org.jboss.forge.shell.console.jline.TerminalFactory.get();
    ...
    public ConsoleReader(final InputStream in, final Writer out, final org.jboss.forge.shell.console.jline.Terminal term) throws IOException {
