    ...
    extends TerminalSupport
{
    ...
    public UnixTerminal() throws Exception {
        ...
        this.replayStream = new org.jboss.forge.shell.console.jline.internal.ReplayPrefixOneCharInputStream(org.jboss.forge.shell.console.jline.internal.Configuration.getInputEncoding());
    ...
    public synchronized void setEchoEnabled(final boolean enabled) {
        try {
            ...
            org.jboss.forge.shell.console.jline.internal.Log.error("Failed to ", (enabled ? "enable" : "disable"), " echo: ", e);
        }
    }
