...
/**
 * Helper class for creating queries (collections of {@link PatternImpl}s) from String query expressions
 * 
...
public class Patterns
{
   ...
   private static final Pattern[] ARRAY_CAST = new PatternImpl[]
   {};

   /**
    * Creates a query collection of {@link PatternImpl}s from the specified {@link String}-formed query expression
    * 
   ...
   public static Pattern[] from(final String queryExpression) throws IllegalArgumentException
   {
      ...
      for (final String path : paths)
      {
         ...
         Pattern pattern = new PatternImpl(name);
         pattern.text(text);
