...
import org.jboss.forge.addon.parser.xml.query.CreateQuery;
import org.jboss.forge.addon.parser.xml.query.GetOrCreateQuery;
import org.jboss.forge.addon.parser.xml.query.GetQuery;
import org.jboss.forge.addon.parser.xml.query.GetSingleQuery;
import org.jboss.forge.addon.parser.xml.util.Patterns;

/**
 * {@link NodeImpl} is a data structure representing a container in a classic tree. May sometimes be synonymous with the
 * term "Element" in XML. It may contain a {@link Map} of attributes ({@link String}s), a reference to a {@link List} of
 * child {@link NodeImpl}s, and text data.
 * 
...
public class NodeImpl implements Node
{
   ...
   /**
    * Name of the {@link NodeImpl}; may not have spaces
    */
   ...
   /**
    * Creates a root {@link NodeImpl}
    * 
    * @param name The name of the node
    */
   public NodeImpl(final String name) throws IllegalArgumentException
   {
      this(name, null);
   }

   /**
    * Creates a {@link NodeImpl}
    * 
    * @param name The name of the node
    ...
    */
   public NodeImpl(final String name, final Node parent) throws IllegalArgumentException
   {
      // Precondition checks
      if (name == null)
      {
    ...
    * @return This {@link NodeImpl}
    * @see #attribute(String, String)
    */
   public NodeImpl attribute(final String name, final Object value)
   {
    ...
    * @return This {@link NodeImpl}
    */
   public NodeImpl attribute(final String name, final String value)
   {
   ...
   /**
    * Returns whether or not this {@link NodeImpl} represents a comment
    * 
    * @return
    */
   ...
   /**
    * Marks this {@link NodeImpl} as a comment
    * 
   ...
   public void setComment(final boolean comment) throws IllegalArgumentException
   {
      ...
      {
         throw new IllegalArgumentException("Cannot mark a " + NodeImpl.class.getSimpleName()
   ...
   /**
    * Obtains the root {@link NodeImpl} for this reference
    * 
    * @return
    */
   public Node getRoot()
   ...
   /**
    * Returns whether or not this {@link NodeImpl} is a root
    * 
    * @return
    */
   ...
   /**
    * Create a new {@link NodeImpl} with given name. <br/>
    * <br/>
    * The new {@link NodeImpl} will have this as parent.
    * 
    * @param name The name of the {@link NodeImpl}.
    * @return A new child {@link NodeImpl}
    * @throws IllegalArgumentException If the name is not specified
    */
   ...
   /**
    * Add a child to this {@link NodeImpl}
    * 
    * @return false if this node already contained the given child, true otherwise
    */
   ...
   /**
    * Remove a single child from this {@link NodeImpl}
    * 
   ...
   /**
    * Returns a multiline {@link String} format of this {@link NodeImpl} and all children
    * 
    * @param verbose
    * @return
    */
   public String toString(final boolean verbose)
   {
      ...
      sb.append(NodeImpl.class.getSimpleName());
