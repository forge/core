...
public final class PatternImpl implements Pattern
{
   ...
   /**
    * Creates a new {@link PatternImpl} instance with the specified name
    * 
    * @param name
    * @throws IllegalArgumentException If the name is not specified
    */
   public PatternImpl(final String name) throws IllegalArgumentException
   {
      // Precondition check
    ...
    */
   public PatternImpl attribute(final String name, final Object value)
   {
    ...
    * @return This Node
    */
   public PatternImpl attribute(final String name, final String value)
   {
   ...
   /**
    * Returns true if and only if the specified {@link NodeImpl} values match the data contained in this {@link PatternImpl}
    * value object
    * 
    * @param node
    * @return
   ...
   /**
    * Sets the node text to match, returning a reference to this {@link PatternImpl}
    * 
    * @param text The text value which should be matched
    * @return This {@link PatternImpl}
    */
   public PatternImpl text(final String text)
   {
      this.text = text;
      return this;
   }
