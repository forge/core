...
.. Download link:https://repository.jboss.org/nexus/service/local/artifact/maven/redirect?r=releases&g=org.jboss.forge&a=forge-distribution&v=LATEST&e=zip&c=offline[JBoss Forge 2.4.1.Final - Offline (Recommended)]
... This ZIP contains the Forge runtime + Core Addons
.. Download link:https://repository.jboss.org/nexus/service/local/artifact/maven/redirect?r=releases&g=org.jboss.forge&a=forge-distribution&v=LATEST&e=zip[JBoss Forge 2.4.1.Final - No Addons]
... This ZIP contains the Forge runtime only

* Extract the ZIP to a directory and navigate to forge-distribution-2.4.1.Final/bin directory
...
____
Forge 2 is known to work with Eclipse Luna (4.3) or higher versions.
____
