...
- Command line tools - https://repository.jboss.org/nexus/service/local/artifact/maven/redirect?r=releases&g=org.jboss.forge&a=forge-distribution&v=2.0.0.CR1&e=zip


=== Get Started with the Command line tools:

- Download link:https://repository.jboss.org/nexus/service/local/artifact/maven/redirect?r=releases&g=org.jboss.forge&a=forge-distribution&v=2.0.0.BCR1&e=zip[JBoss Forge 2.0.0.CR1]
- Extract the ZIP to a directory and navigate to forge-distribution-2.0.0.CR1/bin directory
