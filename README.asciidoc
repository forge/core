...
See the JavaDocs here: http://docs.jboss.org/forge/javadoc/2.1.0-SNAPSHOT/
...
- Command line tools - https://repository.jboss.org/nexus/service/local/artifact/maven/redirect?r=releases&g=org.jboss.forge&a=forge-distribution&v=2.1.0.Final&e=zip


=== Get Started with the Command line tools:

- Download link:https://repository.jboss.org/nexus/service/local/artifact/maven/redirect?r=releases&g=org.jboss.forge&a=forge-distribution&v=2.1.0.Final&e=zip[JBoss Forge 2.1.0.Final]
- Extract the ZIP to a directory and navigate to forge-distribution-2.1.0.Final/bin directory
