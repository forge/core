...
- Command line tools - https://repository.jboss.org/nexus/service/local/artifact/maven/redirect?r=releases&g=org.jboss.forge&a=forge-distribution&v=2.0.0.Alpha10&e=zip
...
- Extract the ZIP to a folder and navigate to forge-2.0.0.Alpha10/bin folder
