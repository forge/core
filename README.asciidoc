...
.. Download link:https://repository.jboss.org/nexus/service/local/artifact/maven/redirect?r=releases&g=org.jboss.forge&a=forge-distribution&v=2.3.0.Final&e=zip&c=offline[JBoss Forge 2.3.0.Final - Offline (Recommended)]
... This ZIP contains the Forge runtime + Core Addons
.. Download link:https://repository.jboss.org/nexus/service/local/artifact/maven/redirect?r=releases&g=org.jboss.forge&a=forge-distribution&v=2.3.0.Final&e=zip[JBoss Forge 2.3.0.Final - No Addons]
