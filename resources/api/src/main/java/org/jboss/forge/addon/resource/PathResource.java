...
public interface PathResource<T extends PathResource<T>> extends Resource<Path>,
    ...
    /**
     * Return true if this {@link FileResource} exists and is actually a
    ...
    /**
     * Re-read the file-system meta-data for this resource (such as last
     * modified time-stamp, and permissions.)
     */
    public void refresh();

    /**
     * Create a new single directory for this resource. This will not succeed if
     * any parent directories needed for this resource to exist are missing. You
     * should consider using {@link #mkdirs()}
     */
    ...
    /**
     * Requests that the file or directory denoted by this resource be deleted
    ...
    /**
     * Create the file in the underlying resource system. Necessary directory
