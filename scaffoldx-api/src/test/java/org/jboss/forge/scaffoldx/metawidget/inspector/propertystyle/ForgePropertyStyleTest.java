 ...
 */
package org.jboss.forge.scaffoldx.metawidget.inspector.propertystyle;
         ...
         extends AbstractShellTest
{
            ...
            throws Exception
   {
      ...
      ScaffoldUtil
               .createOrOverwrite(
                        null,
                        java.getJavaResource("org/jboss/forge/scaffoldx/metawidget/inspector/propertystyle/MockAnnotatedClass.java"),
                        getClass()
                                 .getResourceAsStream(
                                          "/org/jboss/forge/scaffoldx/metawidget/inspector/propertystyle/MockAnnotatedClass.java"),
                        true);
      ...
      Map<String, Property> properties = propertyStyle
               .getProperties("org.jboss.forge.scaffoldx.metawidget.inspector.propertystyle.MockAnnotatedClass");
            ...
            throws Exception
   {
      ...
      ScaffoldUtil
               .createOrOverwrite(
                        null,
                        java.getJavaResource("org/jboss/forge/scaffoldx/metawidget/inspector/propertystyle/ManuallyGeneratedClass.java"),
                        getClass()
                                 .getResourceAsStream(
                                          "/org/jboss/forge/scaffoldx/metawidget/inspector/propertystyle/ManuallyGeneratedClass.java"),
                        true);

      ForgePropertyStyle propertyStyle = new ForgePropertyStyle(new ForgePropertyStyleConfig().setProject(project));
      Map<String, Property> properties = propertyStyle
               .getProperties("org.jboss.forge.scaffoldx.metawidget.inspector.propertystyle.ManuallyGeneratedClass");
            ...
            throws Exception
   {
      ...
      ScaffoldUtil
               .createOrOverwrite(
                        null,
                        java.getJavaResource("org/jboss/forge/scaffoldx/metawidget/inspector/propertystyle/ManuallyGeneratedSubclass.java"),
                        getClass()
                                 .getResourceAsStream(
                                          "/org/jboss/forge/scaffoldx/metawidget/inspector/propertystyle/ManuallyGeneratedSubclass.java"),
                        true);

      ForgePropertyStyle propertyStyle = new ForgePropertyStyle(new ForgePropertyStyleConfig().setProject(project));
      Map<String, Property> properties = propertyStyle
               .getProperties("org.jboss.forge.scaffoldx.metawidget.inspector.propertystyle.ManuallyGeneratedSubclass");
