...
public class PropertyConstraintPluginTest extends SingletonAbstractShellTest
{
    ...
    {
        final String message = "Message";
        getShell().execute(CONSTRAINT_PLUGIN_NAME + " AssertTrue --onProperty " + PROPERTY_NAME + " --message " + message);
    ...
    {
        final String message = "Message";
        getShell().execute(CONSTRAINT_PLUGIN_NAME + " AssertFalse --onProperty " + PROPERTY_NAME + " --message " + message);
    ...
    {
        final String message = "Message";
        getShell().execute(CONSTRAINT_PLUGIN_NAME + " Min --onProperty " + PROPERTY_NAME + " --min 3 --message " + message);
    ...
    {
        final String message = "Message";
        getShell().execute(CONSTRAINT_PLUGIN_NAME + " Max --onProperty " + PROPERTY_NAME + " --max 3 --message " + message);
    ...
    {
        final String message = "Message";
        getShell().execute(CONSTRAINT_PLUGIN_NAME + " DecimalMin --onProperty " + PROPERTY_NAME + " --min 3 --message " + message);
        getShell().execute(CONSTRAINT_PLUGIN_NAME + " DecimalMin --onProperty " + PROPERTY_NAME + " --min 3 --onAccessor");
    ...
    {
        final String message = "Message";
        getShell().execute(CONSTRAINT_PLUGIN_NAME + " DecimalMax --onProperty " + PROPERTY_NAME + " --max 3 --message " + message);
        getShell().execute(CONSTRAINT_PLUGIN_NAME + " DecimalMax --onProperty " + PROPERTY_NAME + " --max 3 --onAccessor");
    ...
    {
        final String message = "Message";
        getShell().execute(CONSTRAINT_PLUGIN_NAME + " Digits --onProperty " + PROPERTY_NAME + " --integer 3 --fraction 4 --message " + message);
        getShell().execute(CONSTRAINT_PLUGIN_NAME + " Digits --onProperty " + PROPERTY_NAME + " --integer 4 --fraction 3 --onAccessor");
    ...
    {
        final String message = "Message";
        getShell().execute(CONSTRAINT_PLUGIN_NAME + " Pattern --onProperty " + PROPERTY_NAME + " --regexp [a-z]* --message " + message);
        getShell().execute(CONSTRAINT_PLUGIN_NAME + " Pattern --onProperty " + PROPERTY_NAME + " --regexp [a-z]* --onAccessor");
