...
public class PropertyCompleterTest extends SingletonAbstractShellTest
{
    ...
    @Test
    public void testCompletionOnClassWithProperties() throws FileNotFoundException
    {
        // creates Foo class
    ...
    @Test
    public void testCompletionOnClassWithoutProperties() throws FileNotFoundException
    {
        // creates a Foo class
    ...
    private JavaResource createFooClass(Project project, String... propertyNames) throws FileNotFoundException
    {
