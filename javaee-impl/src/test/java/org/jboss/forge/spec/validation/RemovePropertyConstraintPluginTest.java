...
public class RemovePropertyConstraintPluginTest extends SingletonAbstractShellTest
{
    ...
    @Test
    public void testRemoveConstraintOnProperty() throws FileNotFoundException
    {
    ...
    @Test
    public void testRemoveConstraintOnPropertyAccessor() throws FileNotFoundException
    {
        final JavaSourceFacet facet = project.getFacet(JavaSourceFacet.class);
        assertNotNull(facet);
