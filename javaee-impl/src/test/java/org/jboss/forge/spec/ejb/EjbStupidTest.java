...
import org.jboss.forge.spec.javaee.ejb.EjbType;
import org.jboss.forge.spec.javaee.ejb.TestEjb;
import org.jboss.forge.test.AbstractShellTest;
import org.junit.Test;
import org.junit.runner.RunWith;

@RunWith(Arquillian.class)
public class EjbStupidTest extends AbstractShellTest {
	...
	public void test4() {
		...
		javaClass.setName("FlowerTest");
		javaClass.setPackage("it.coopservice.test");
		javaClass.addInterface(TestEjb.class);
		Class clazz = null;
		try {
			clazz = Class.forName(TestEjb.class.getName());
