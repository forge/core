...
public class EJBPluginTest extends SingletonAbstractShellTest
{
   ...
   public static JavaArchive getDeployment()
   {
      ...
      JavaArchive archive = ShrinkWrap.create(JavaArchive.class, "test.jar")
               ...
               // .addPackages(true, JavaPlugin.class.getPackage())
   ...
   public void testNewEJbStateless() throws Exception
   {
      ...
      getShell()
               .execute(
                        "ejb new-ejb --package com.test --named FlowerEjb --type STATELESS");
      JavaSourceFacet javaClass = getProject().getFacet(JavaSourceFacet.class);
      JavaResource resource = javaClass.getJavaResource("com.test.FlowerEjb");
   ...
   public void testNewEJbStatelessWithoutPackage() throws Exception
   {
      ...
      getShell()
               .execute(
                        "ejb new-ejb --named FlowerEjb --type STATELESS");
      JavaSourceFacet javaClass = getProject().getFacet(JavaSourceFacet.class);
      JavaResource resource = javaClass.getJavaResource("com.test.FlowerEjb");
      Assert.assertTrue(resource.exists());
      JavaSource<?> source = resource.getJavaSource();
   ...
   public void testNewEJbStateful() throws Exception
   {
      ...
      getShell()
               .execute(
                        "ejb new-ejb --package com.test --named FlowerEjb --type STATEFUL");
      JavaSourceFacet java = getProject().getFacet(JavaSourceFacet.class);
      JavaResource resource = java.getJavaResource("com.test.FlowerEjb");
      Assert.assertTrue(resource.exists());
      JavaSource<?> source = resource.getJavaSource();
      Assert.assertNotNull(source);
      Assert.assertEquals("com.test", source.getPackage());
            ...
            throws Exception
   {
      ...
      getShell()
               .execute(
                        "ejb new-ejb --package com.test --named FlowerEjb --type STATELESS");
      queueInputLines("", "");
      getShell().execute("java new-method 'public void test(){}'");
      ...
      Assert.assertTrue(resource.exists());
      JavaSource<?> source = resource.getJavaSource();
      assertTrue(source.toString().contains("javax.ejb.TransactionAttribute"));
   }
   ...
   public void testNewMDB() throws Exception
   {
      ...
      getShell()
               .execute(
                        "ejb new-ejb --package com.test --named FlowerEjb --type MESSAGEDRIVEN");
      queueInputLines("", "");
      JavaSourceFacet javaClass = getProject().getFacet(JavaSourceFacet.class);
      JavaResource resource = javaClass.getJavaResource("com.test.FlowerEjb");
      Assert.assertTrue(resource.exists());
