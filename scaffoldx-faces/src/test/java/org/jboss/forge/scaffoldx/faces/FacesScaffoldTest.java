...
import org.jboss.forge.scaffoldx.faces.FacesScaffold;
...
public class FacesScaffoldTest extends AbstractFacesScaffoldTest
{
   ...
   public void testScaffoldSetupWithScaffoldTypeWithoutTargetDir() throws Exception
   {
      ...
      queueInputLines("", "", "2", "", "", "");
      getShell().execute("scaffold-x setup --scaffoldType faces");
      Assert.assertTrue(project.hasFacet(FacesScaffold.class));
   }
   ...
   public void testScaffoldSetupWithScaffoldTypeAndTargetDir() throws Exception
   {
      ...
      getShell().execute("persistence setup");
      queueInputLines("", "", "2", "", "", "");
      getShell().execute("scaffold-x setup --scaffoldType faces --targetDir store");
      Assert.assertTrue(project.hasFacet(FacesScaffold.class));
   }
   ...
   public void testCannotGenerateFromEntityUntilScaffoldInstalled() throws Exception
   {
      ...
      queueInputLines("", "");
      getShell().execute("scaffold-x from");
   }
   ...
   */
   ...
   public void testGenerateManyToOneEntity() throws Exception
   {
      ...
      getShell().execute("cd ~~");
      queueInputLines("", "");
      getShell().execute("scaffold-x from src/main/java/com/test/model/Employer.java src/main/java/com/test/model/Customer.java");
   ...
   public void testGenerateRecursiveManyToOneEntity() throws Exception
   {
      ...
      getShell().execute("cd ~~");
      queueInputLines("", "");
      getShell().execute("scaffold-x from src/main/java/com/test/model/Customer.java");
   ...
   public void testGenerateOneToManyEntity() throws Exception
   {
      ...
      getShell().execute("cd ~~");
      queueInputLines("", "");
      getShell().execute("scaffold-x from src/main/java/com/test/model/Grocery.java src/main/java/com/test/model/Customer.java");
...
*/
   ...
   public void testGenerateFromNestedOneToOne() throws Exception
   {
      ...
      queueInputLines("", "", "", "", "");
      getShell()
               .execute("scaffold-x from src/main/java/com/test/model/*");
