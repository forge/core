...
import org.jboss.forge.container.impl.AddonUtil.AddonDependency;
import org.jboss.forge.container.impl.exception.ContainerException;
import org.jboss.forge.container.impl.modules.providers.ForgeContainerAPISpec;
import org.jboss.forge.container.impl.modules.providers.ForgeContainerSpec;
import org.jboss.forge.container.impl.modules.providers.SystemClasspathSpec;
import org.jboss.forge.container.impl.modules.providers.WeldClasspathSpec;
...
public class AddonModuleLoader extends ModuleLoader
{
   ...
   public ModuleSpec findAddonModule(ModuleIdentifier id)
   {
      ...
      if (found != null)
      {
         ...
         builder.addDependency(DependencySpec.createModuleDependencySpec(WeldClasspathSpec.ID));
         builder.addDependency(DependencySpec.createModuleDependencySpec(ForgeContainerAPISpec.ID));
         builder.addDependency(DependencySpec.createModuleDependencySpec(ForgeContainerSpec.ID));

         builder.addDependency(DependencySpec.createClassLoaderDependencySpec(
                  ClassLoader.getSystemClassLoader(),
                  new HashSet<String>(Arrays.asList("META-INF/services")), false));
