...
public class FacesScaffold extends BaseFacet implements ScaffoldProvider
{
   ...
   private NamespacesAndIndent parseNamespacesAndIndent(InputStream streamIn)
   {
   ...
   private void writeMetawidget(Map<Object, Object> context, int indent, Map<String, String> existingNamespaces)
   {
   ...
   private static class NamespacesAndIndent
   {
      ...
      public NamespacesAndIndent(Map<String, String> namespaces, int indent)
      {
