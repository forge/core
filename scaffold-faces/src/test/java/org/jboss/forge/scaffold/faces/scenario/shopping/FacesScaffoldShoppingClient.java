...
public class FacesScaffoldShoppingClient
{
   ...
   public void testAll() throws Exception
   {
      ...
      try
      {
         ...
         assertEquals("Address id : 2", table.getCellAt(2, 0).getTextContent());
         ...
         page = page.getHtmlElementById("create:customerBeanCustomerOrders:customerBeanCustomerOrdersAdd").click();
         table = (HtmlTable) page.getHtmlElementById("create:customerBeanCustomerOrders");
         assertTrue( "Address id : 2".equals(table.getCellAt(2, 0).getTextContent()) || "Address id : 3".equals(table.getCellAt(2, 0).getTextContent() ));
         assertTrue( "Address id : 2".equals(table.getCellAt(3, 0).getTextContent()) || "Address id : 3".equals(table.getCellAt(3, 0).getTextContent() ));
         ...
         assertTrue( "Address id : 2".equals(table.getCellAt(1, 0).getTextContent()) || "Address id : 3".equals(table.getCellAt(1, 0).getTextContent() ));
         assertTrue( "Address id : 2".equals(table.getCellAt(2, 0).getTextContent()) || "Address id : 3".equals(table.getCellAt(2, 0).getTextContent() ));
