 ...
 */
public class AggregateNoUIWizard extends AbstractUICommand implements UIWizard
{
   @Override
   ...
   {
      return Metadata.from(super.getMetadata(context), getClass()).name("aggregate-noui-wizard");
   }
