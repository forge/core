...
/**
 * This class allows decoration of {@link UISelectMany} objects
 * 
 * @author <a href="mailto:ggastald@redhat.com">George Gastaldi</a>
 */
public abstract class AbstractUISelectManyDecorator<VALUETYPE> implements UISelectMany<VALUETYPE>
{

   private UISelectMany<VALUETYPE> delegate;

   /**
    * Create the delegate {@link UISelectMany} to be used in this implementation
    * 
    * @return a new instance of the {@link UISelectMany} object
    */
   protected abstract UISelectMany<VALUETYPE> createDelegate();
   ...
   @Override
   public UISelectMany<VALUETYPE> setEnabled(boolean b)
   {
   ...
   @Override
   public UISelectMany<VALUETYPE> setEnabled(Callable<Boolean> callable)
   {
   ...
   @Override
   public UISelectMany<VALUETYPE> setLabel(String label)
   {
   ...
   @Override
   public UISelectMany<VALUETYPE> setDescription(String description)
   {
   ...
   @Override
   public UISelectMany<VALUETYPE> setDescription(Callable<String> description)
   {
      getDelegate().setDescription(description);
      return this;
   }
   ...
   @Override
   public UISelectMany<VALUETYPE> setRequired(boolean required)
   {
   ...
   @Override
   public UISelectMany<VALUETYPE> setRequired(Callable<Boolean> required)
   {
      getDelegate().setRequired(required);
      return this;
   }
   ...
   @Override
   public UISelectMany<VALUETYPE> setRequiredMessage(String message)
   {
   ...
   @Override
   public UISelectMany<VALUETYPE> setRequiredMessage(Callable<String> message)
   {
      getDelegate().setRequiredMessage(message);
      return this;
   }
   ...
   @Override
   public UISelectMany<VALUETYPE> addValidator(UIValidator validator)
   {
   ...
   @Override
   public UISelectMany<VALUETYPE> setNote(String note)
   {
   ...
   @Override
   public UISelectMany<VALUETYPE> setNote(Callable<String> note)
   {
      getDelegate().setNote(note);
      return this;
   }
   ...
   @Override
   public UISelectMany<VALUETYPE> setValueChoices(Iterable<VALUETYPE> values)
   {
   ...
   @Override
   public UISelectMany<VALUETYPE> setValueChoices(Callable<Iterable<VALUETYPE>> values)
   {
      getDelegate().setValueChoices(values);
      return this;
   }
