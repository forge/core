...
public class NewEmbeddableCommand extends AbstractJavaEECommand implements PrerequisiteCommandsProvider
{
   @Inject
   ...
   {
      return Metadata.from(super.getMetadata(context), getClass()).name("JPA: New Embeddable")
   ...
   public Result execute(UIExecutionContext context) throws Exception
   {
      ...
      if (project == null)
      {
         javaResource = persistenceOperations.newEmbeddableEntity(targetDir, entityName, entityPackage);
      }
      else
      {
         javaResource = persistenceOperations.newEmbeddableEntity(project, entityName, entityPackage);
      }
      context.getUIContext().setSelection(javaResource);
      return Results.success("Embeddable entity " + javaResource + " created");
   }
