...
/**
 * Test class for {@link ValidationFacet}
 * 
 * @author <a href="mailto:ggastald@redhat.com">George Gastaldi</a>
 */
@RunWith(Arquillian.class)
public class ValidationFacetTest
{
   @Deployment
   @AddonDependencies
   ...
   @Test
   public void testValidationFacetVersion() throws Exception
   {
      Project project = projectFactory.createTempProject();
      ValidationFacet facet = facetFactory.install(project, ValidationFacet.class);
      Assert.assertEquals("1.1", facet.getConfig().getVersion());
   }
