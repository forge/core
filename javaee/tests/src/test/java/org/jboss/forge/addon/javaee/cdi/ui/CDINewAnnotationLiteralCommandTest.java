...
public class CDINewAnnotationLiteralCommandTest
{
   @Deployment
   @AddonDependencies
   ...
   {
      try (CommandController controller = uiTestHarness.createCommandController(CDINewAnnotationLiteralCommand.class,
               project.getRoot()))
      {
         controller.initialize();
         // Checks the command metadata
         assertTrue(controller.getCommand() instanceof CDINewAnnotationLiteralCommand);
         UICommandMetadata metadata = controller.getMetadata();
         assertEquals("CDI: New Annotation Literal", metadata.getName());
   ...
   @Test
   public void testCreateNewAnnotationLiteral() throws Exception
   {
      try (CommandController controller = uiTestHarness.createCommandController(CDINewAnnotationLiteralCommand.class,
               project.getRoot()))
      {
