...
public class ScaffoldGenerateWizardTest
{
   ...
   public void testScaffoldGenerateWithSetup() throws Exception
   {
      ...
      Assert.assertFalse(scaffoldProvider.isSetup(project, new ScaffoldSetupContext("", true)));
      ...
      Assert.assertTrue(scaffoldProvider.isSetup(project, new ScaffoldSetupContext("", true)));
   }
}
